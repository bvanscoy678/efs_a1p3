...
def portfolio(request,pk):
   ...
   investment_results = recent_value - acquired_value
   stock_results = 0
   portfolio_initial_investments = 0
   portfolio_initial_investments = sum_of_initial_stock_value + acquired_value
   portfolio_current_investments = 0
   portfolio_current_investments = sum_current_stocks_value + sum_of_initial_stock_value
   grand_total_results = 0
   grand_total_results = portfolio_current_investments - portfolio_initial_investments
   stocks_current = 0
   stocks_current = sum_current_stocks_value
   stocks_recent =0
   stocks_recent = sum_of_initial_stock_value
   stocks_results = 0
   stocks_results = stocks_current - stocks_recent
